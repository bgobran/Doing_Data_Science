...
#          sample size
#
# The first step is to create very large arrays of the normal and exponential
#     distributions that we will extract our samples from.
#
...
message ("The normal distribution means are ", round(yns1,4), " and ", round(yns2,4))


message ("These two exponential distribution means should be ", round(1/erate,4))
message ("The exponential distribution means are ", round(yes1,4), " and ", round(yes2,4))
...
message ("The normal distribution standard deviations are ", round(sns1,4), " and ", round(sns2,4))
...
message ("The exponential distribution standard deviations are ", round(ses1,4), " and ", round(ses2,4))
